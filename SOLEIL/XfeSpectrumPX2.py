...
class XfeSpectrumPX2(Equipment):
    ...
    def init(self):
        logging.info('I am the XfeSpectrumPX2')
        self.scanning = None
        self.moving = None
    ...
    def isConnected(self):
        return True
        logging.info('XfeSpectrumPX2, isConnected, self.doSpectrum.isConnected is %s' % self.doSpectrum.isConnected())
        try:
    ...
    def canSpectrum(self):
        logging.info('XfeSpectrumPX2, canSpectrum, self.doSpectrum is %s' % self.doSpectrum)
