...
class PX1MultiCollect(SOLEILMultiCollect):
    def __init__(self, name):
        SOLEILMultiCollect.__init__(self, name, LimaPilatusDetector(), TunableEnergy())
...
#
    ...
    def setHelical(self, onoff):
        if onoff:
           logging.getLogger("Setting helical option to ON. But the code is not written yet for this")
        else:
           logging.getLogger("Setting helical option to OFF")
