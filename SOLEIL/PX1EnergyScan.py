from SOLEILEnergyScan2 import *
import logging
#import calc_gaps

class PX1EnergyScan(SOLEILEnergyScan2):
    def __init__(self, name):
        SOLEILEnergyScan2.__init__(self, name, TunableEnergy())
    ...
    def set_mca_roi(self, eroi_min, eroi_max):
        ...
        self.fluodet.set_roi(eroi_min, eroi_max)
