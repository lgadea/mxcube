...
class SampleChanger(Equipment):
    ...
    def is_mounted_sample(self, sample_location):
      logging.getLogger().info("checking if sample in location")
      if sample_location == self.getLoadedSampleLocation():
        return True
      else:
        return False
      logging.getLogger().info("checking if sample in location done")
